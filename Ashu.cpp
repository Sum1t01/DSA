...
{
    char doc_name[20], doc_Qualification[20], doc_age[20], doc_exp[20], doc_city[20], doc_special[20];
    int doc_id;
public:
    friend class doctor;
    details_doctor1()
...
{
    int pat_id1;
    char pat_name[20], pat_age[20], pat_city[20], pat_dis[20], pat_room[20], pat_sym[20], pat_con[20], pat_date[20], pat_charg[20], pat_bill[20];
public:
...
void doctor::Display()
{
    ...
    else
    {
        ...
        if (status)
        {
            ...
            cout << "6.Doctor's Experience         :" << arr[i].doc_exp << "\n\n";
            cout << "8.Doctor's city               :" << arr[i].doc_city << "\n\n";
...
void patient::add_pat_info()
{
    ...
    for (i = 1; i <= ent; i++)
    {
        ...
        cout << "5.Please Enter patient's Symptoms :                           :";
        cin >> arr[docid1].pat_sym;
        cout << "6.Please Enter Patient's Room No :                           :";
        cin >> arr[docid1].pat_room;
        cout << "7.Please Enter Patient's condition Before Admit :             :";
        cin >> arr[docid1].pat_con;
        cout << "8.Please Enter Patient's ADMIT Date :                         :";
        cin >> arr[docid1].pat_date;
        cout << "9.Please Enter Patient's Room Charge :                        :";
        cin >> arr[docid1].pat_charg;
        cout << "10.Please Enter Patient's Medicine charge :                   :";
...
void patient ::Display()
{
    ...
    else
    {
        ...
        if (status == 1)
        {
            ...
            cout << "5.Patient's Symptoms                                :" << arr[i].pat_sym << "\n";
            cout << "6.Patient's Room No.                                :" << arr[i].pat_room << "\n";
            cout << "7.Patient's condition Before Admit                  :" << arr[i].pat_con << "\n";
            cout << "8.Patient's ADMIT Date                              :" << arr[i].pat_date << "\n";
            cout << "9.Patient's Room Charge                             :" << arr[i].pat_charg << "\n";
            cout << "10.Patient's Medicine charge                        :" << arr[i].pat_bill << "\n";
            cout << "\nPress Any KEY To choose another Option...";
        }
        else
        {
...
void patient ::patient_report()
{
    ...
    if (status)
    {
        ...
        cout << "3. Patient symptoms: " << arr[i].pat_sym << "\n";
        cout << "4. Patient Disease: " << arr[i].pat_dis << "\n";
        cout << "5. Patient Admit Date: " << arr[i].pat_date << "\n";
        cout << "6. Patient condition At The Time Of Discharge: " << arr[i].pat_con << "\n";
...
void patient ::patient_detail()
{
    ...
    else
    {
        ...
        for (i = 0; i < docid1; i++)
        {
            cout << arr[i].pat_id1 << "\t \t" << arr[i].pat_dis << "\t \t \t" << arr[i].pat_date << "\t  \t \t" << arr[i].pat_age << "\n";
        }
        cout << " \n Press Any KEY To choose another Option.... ";
    }
    getch();
...
void patient ::gen_pat_report()
{
    ...
    if (status)
    {
        ...
        cout << "------------------------------------------" << endl
             << endl;
        cout << "1. Patient's Medicine Charge: " << arr[i].pat_bill << "\n";
        cout << "2. Patient's Room Charge: " << arr[i].pat_charg << "\n";
        cout << "Press Any Key To Go Back...";
    }
